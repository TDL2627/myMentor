<template>
  <div class="dashboard">
    ...
    <router-link to="/main"
      ><img class="nav-logo" src="@/assets/mentlogo.png" alt="logo"
    /></router-link>
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-6">
          <router-link to="/dashboard/notelist"
            ><h3 class="tabby">STUDENTS NOTES</h3></router-link
          >
        </div>
        <div class="col-lg-6">
          <router-link to="/dashboard/studentlist">
            <h3 class="tabby">EVERYONES PROFILES</h3></router-link
          >
        </div>
      </div>
    </div>
